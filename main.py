...
from docp import process_and_embed_document, build_prompt_with_context
from mdlc import ModelConfig
...
embedding_func = model_config.embedding_func
chroma_client = model_config.chroma_client
collection = model_config.chat_sessions
